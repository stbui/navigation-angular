...
app.controller('searchCtl', function ($scope, $state) {

    $scope.change = function () {
        var key = $scope.keyword;
        // $state.go('app.search',{key:key});
    }
...
app.controller('userLoginCtl', function ($rootScope,$scope, $modal, $localStorage) {
...
app.controller('modalUserLoginCtl', function ($scope,$modalInstance, $localStorage, $log) {
    ...
    $scope.login = function () {
        ...
        $log.info('Current User: ' + $localStorage.userInfo.username);
        $modalInstance.dismiss('cancel');
    }
...
app.controller('profileCtl', function ($scope,$stateParams) {
